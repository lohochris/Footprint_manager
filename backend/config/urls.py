...
urlpatterns = [
    ...
    path("api/v1/auth/", include("backend.apps.accounts.api.urls")),
    path("api/v1/", include("backend.apps.organizations.api.urls")),
    ...
    path("api/v1/decision-engine/", include("backend.apps.decision_engine.urls")),
